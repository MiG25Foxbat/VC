        ...
        if (card.letter == null ||
          ...
          const Card(
            child: Padding(
              ...
              child: Text(
                'Письмо не написано: либо ещё не задан LLM_API_KEY на '
                'сервере, либо модель не отработала. Отсутствие имени '
                'руководителя этому не мешает — письмо пишется в любом '
                'случае, на основе того, что есть.',
              ),
            ),
          )
        else ...[
